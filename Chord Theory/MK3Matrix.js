...
let chord9maj7 = new Chord(9,eighth,'7/B','major','-','-','Maj7','Ab');
let chord10maj7 = new Chord(10,eighth,'-','major','-','-','Maj7','A');
let chord11maj7 = new Chord(11,overEight,'-','major','-','-','Maj7','Bb');
let chord12maj7 = new Chord(12,eighth,'7/B','major','-','-','Maj7','B');
...
let chord2min1 = new Chord(2,root,'mi/Eb','minor','-','-','Min1','C#');
...
let chord10min1 = new Chord(10,sixth,'mi/Ab','minor','-','-','Min1','A');
let chord11min1 = new Chord(11,root,'mi/G','minor','-','-','Min1','Bb');
let chord12min1 = new Chord(12,eighth,'-','major','-','-','Min1','B');

let chord1min2 = new Chord(1,root,'mi','minor','-','-','Min2','C');
let chord2min2 = new Chord(2,eighth,'+/B','major','-','-','Min2','C#');
let chord3min2 = new Chord(3,root,'mi/Bb','minor','-','-','Min2','D');
let chord4min2 = new Chord(4,root,'mi/A','minor','-','-','Min2','Eb');
...
let chord7min3 = new Chord(7,root,'mi/G','minor','-','-','Min3','F#');
...
let chord11min4 = new Chord(11,sixth,'mi/G','minor','-','-','Min4','Bb');
...
let chord7min5 = new Chord(7,root,'mi/Eb','minor','-','-','Min5','F#');
...
let chord9min6 = new Chord(9,ninth,'/G','major','-','-','Min6','Ab');
let chord10min6 = new Chord(10,eighth,'7','major','-','-','Min6','A');
let chord11min6 = new Chord(11,root,'mi/G','minor','-','-','Min6','Bb');
...
let chord6min7 = new Chord(6,fourth,'ma7/F','major','-','-','Min7','F');
...
let chord3min8 = new Chord(3,root,'mi11/G','minor','-','-','Min8','D');
