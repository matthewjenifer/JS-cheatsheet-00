...
let set9a = new Chord('Maj1',9,'Fadd9','major');
...
let set9n = new Chord('Min6',9,'Ab/G','majnor');
let set10n = new Chord('Min6',10,'G7','major');
let set11n = new Chord('Min6',11,'Cm/G','minor');
...
let set6p = new Chord('Min8',6,'Ab mi7','major');
